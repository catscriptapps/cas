...
<div class="space-y-6 max-w-full py-10">
    ...
    <div class="bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-800 rounded-2xl">
        <div class="w-full overflow-x-auto">
            <table class="w-full divide-y divide-gray-200 dark:divide-gray-800 table-fixed min-w-[900px]">
                <thead class="sticky top-[84px] sm:top-[96px] z-[30] shadow-sm rounded-t-2xl overflow-clip">
                    <tr class="bg-gray-50 dark:bg-gray-800/50">
                        ...
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[18%]">
                            <?php $sortColumn = 'division';
                            $sortLabel = 'Division';
                            include __DIR__ . '/../components/ui/sortable-th.php'; ?>
                        </th>
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[15%]">Contact</th>
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[13%]">
                            <?php $sortColumn = 'joined';
                            $sortLabel = 'Registered';
                            include __DIR__ . '/../components/ui/sortable-th.php'; ?>
                        </th>
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[13%]">Payment</th>
