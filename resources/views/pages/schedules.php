...
<div class="space-y-6 max-w-full py-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex-1">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white font-sans">Schedules</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Manage season divisions, view team registrations, and access game schedules.
            </p>
        </div>
