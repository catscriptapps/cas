<?php
// /resources/views/pages/stats.php
...
<div class="space-y-6 max-w-full py-10">
    <?php
    $breadcrumbs = ['Stats+Standings' => '/stats'];
    include __DIR__ . '/../components/ui/breadcrumbs.php';
    ?>

    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex-1">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white font-sans">Stats+Standings</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Team standings and player season stats, broken down by division and season.
            </p>
        </div>
