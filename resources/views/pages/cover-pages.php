<?php
// /resources/views/pages/cover-pages.php
...
<div class="space-y-6 max-w-full py-10">
    <?php
    $breadcrumbs = ['Cover Pages' => '/cover-pages'];
    include __DIR__ . '/../components/ui/breadcrumbs.php';
    ?>

    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex-1">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white font-sans">Cover Pages</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Manage the front and back cover images stitched onto every finished PDF report for your company.
            </p>
        </div>

        <div class="mt-4 md:mt-0 flex flex-row gap-3 items-center">
            <button type="button" id="delete-selected-cover-pages-btn" data-tooltip="Delete Selected"
                ...
                <span id="delete-selected-cover-pages-label" class="hidden xs:inline md:inline">Delete Selected</span>
            </button>

            <button type="button" id="trigger-cover-pages-upload"
    ...
    <div class="bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
        <div class="flex items-center justify-between pb-4 mb-2 border-b border-gray-100 dark:border-gray-800">
            <div class="flex items-center gap-3">
                ...
                <span id="cover-pages-count" class="text-[10px] font-bold text-primary-500 bg-primary-50 dark:bg-primary-950/30 px-2 py-0.5 rounded-md border border-primary-100 dark:border-primary-900/50">0</span>
            </div>
        ...
        <div id="cover-pages-wrapper" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3"></div>
    </div>
</div>
