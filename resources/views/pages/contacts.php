                ...
                <thead class="sticky top-[84px] sm:top-[96px] z-[30] shadow-sm rounded-t-2xl overflow-clip">
                    <tr class="bg-gray-50 dark:bg-gray-800/50">
                        ...
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[20%]">
                            <?php $sortColumn = 'leagues';
                            $sortLabel = 'Leagues';
                            include __DIR__ . '/../components/ui/sortable-th.php'; ?>
                        </th>
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[15%]">
                            <?php $sortColumn = 'phone';
                            $sortLabel = 'Phone';
                            include __DIR__ . '/../components/ui/sortable-th.php'; ?>
                        </th>
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[17%]">
                            <?php $sortColumn = 'role';
                            $sortLabel = 'Role';
                            include __DIR__ . '/../components/ui/sortable-th.php'; ?>
                        </th>
                        <th class="px-6 py-4 text-left hidden lg:table-cell w-[12%]">
                            <?php $sortColumn = 'emergency';
                            $sortLabel = 'Emergency';
                            include __DIR__ . '/../components/ui/sortable-th.php'; ?>
                        </th>
