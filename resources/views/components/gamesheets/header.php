<?php
// /resources/views/components/gamesheets/header.php

use Src\Service\AuthService;
?>

<?php
// Sticky under the fixed topbar -- same offset/opaque-background pattern as
// components/schedules/header.php.
?>
        ...
        <div class="min-w-0">
            <nav class="flex mb-2" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-[10px] font-bold uppercase tracking-widest text-gray-400">
                    <li><a href="<?= $baseUrl ?>gamesheets" data-partial class="hover:text-primary-600 transition-colors">Gamesheets</a></li>
                    <li><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" />
                        </svg></li>
                    <li class="text-gray-900 dark:text-white">Gamesheet Detail</li>
                </ol>
            </nav>
            <h1 class="text-2xl font-black text-gray-900 dark:text-white font-sans tracking-tight uppercase truncate">
                Gamesheets for <span class="text-primary-600"><?= htmlspecialchars((string)$divisionName) ?></span>
