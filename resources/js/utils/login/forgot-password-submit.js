    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (result.success && result.redirect_url) {
                // Local-env bypass: no email was sent, jump straight to the
                // reset page with the token already issued.
                showToast('Local environment — skipping email, redirecting...', 'success');
