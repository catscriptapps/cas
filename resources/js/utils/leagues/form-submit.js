// /resources/js/utils/leagues/form-submit.js

import { FormValidator } from '../../utils/form-validator.js';
import { buttonSpinner } from '../../utils/spinner-utils.js';

export function handleLeagueFormSubmission(form, modalInstance, tableSelector = '#leagues-tbody') {
    if (form._leagueFormListenerAttached) return;
    form._leagueFormListenerAttached = true;
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                is_ball: form.querySelector('input[name="is_ball"]')?.checked ? 1 : 0,
            ...
            console.error('League save error:', err);
