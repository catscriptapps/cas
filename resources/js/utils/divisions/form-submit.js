// /resources/js/utils/divisions/form-submit.js

import { FormValidator } from '../../utils/form-validator.js';
import { buttonSpinner } from '../../utils/spinner-utils.js';

export function handleDivisionFormSubmission(form, modalInstance, tableSelector = '#divisions-tbody') {
    if (form._divisionFormListenerAttached) return;
    form._divisionFormListenerAttached = true;
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                division_name: data.division_name?.trim(),
