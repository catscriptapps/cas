// /resources/js/utils/stats/export-pdf.js

import { showSpinner, hideSpinner } from '../../ui/spinner.js';
import { showToast } from '../../ui/toast.js';

export function initStatsExport() {
    ...
    exportBtn.addEventListener('click', (e) => {
        ...
        const isPlayoffs = document.getElementById('pane-playoffs')?.classList.contains('hidden') ? 0 : 1;
        ...
        try {
            ...
            const streamUrl = `${base}/api/stats-pdf?season_id=${encodeURIComponent(encodedId)}&is_playoff=${isPlayoffs}`;
